                ...
                <div className="card">
                    ...
                    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center mb-4">
                        <div className="flex gap-2">
                            <Button label="ເພີ່ມໃໝ່" icon="pi pi-plus" severity="success" onClick={openNew} />
                            <Button label="ລົບ" icon="pi pi-trash" severity="danger" onClick={confirmDeleteSelected} disabled={!selectedProducts || !(selectedProducts as any).length} />
                        </div>
                    ...
                    >
                        ...
                        <Column field="category" header="ຍີ່ຫໍ້ລົດ" sortable body={categoryBodyTemplate} headerStyle={{ minWidth: '10rem', fontSize:'1.5rem' }}></Column>
                        <Column body={actionBodyTemplate} header="ຈັດການ" headerStyle={{ minWidth: '10rem', fontSize:'1.5rem' }}></Column>
                    </DataTable>

                    <Dialog visible={productDialog} style={{ width: '450px' }} header="ລາຍລະອຽດຂໍ້ມູນຍີ່ຫໍ້ລົດ" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                                            {product.image && <img src={`/demo/images/product/${product.image}`} alt={product.image} width="150" className="mt-0 mx-auto mb-5 block shadow-2" />}
                                            <div className="field">
                                                <label htmlFor="name">ຊື່ຂໍ້ມູນຍີ່ຫໍ້ລົດ</label>
                                                <InputText
                                                    id="name"
                                                    value={product.name}
                                                    ...
                                                    required
                                                    autoFocus
                                                    placeholder='ກະລຸນາປ້ອນຊື່ຂໍ້ມູນຍີ່ຫໍ້ລົດ'
                                                    className={classNames({
                                                        'p-invalid': submitted && !product.name
                                                    })}
                                                />
                                                {submitted && !product.name && <small className="p-invalid text-red-500">ຕ້ອງການຊື່ຂໍ້ມູນຍີ່ຫໍ້ລົດ.</small>}
                                            </div>
