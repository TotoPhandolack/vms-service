            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="category" header="ຝ່າຍ" sortable body={categoryBodyTemplate} headerStyle={{ minWidth: '10rem', fontSize:'1.5rem' }}></Column>
                        <Column body={actionBodyTemplate} header="ຈັດການ" headerStyle={{ minWidth: '10rem', fontSize:'1.5rem' }}></Column>
                    </DataTable>

                    <Dialog visible={productDialog} style={{ width: '450px' }} header="ລາຍລະອຽດຝ່າຍ" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                                            ...
                                            <label htmlFor="name" className="font-bold">
                                                ...
                                                />
                                                {submitted && !product.name && <small className="p-invalid text-red-500">ຕ້ອງການຊື່ຝ່າຍ.</small>}
                                            </div>
